...
## Suggested CV line (truthful once you build the PBIX)

**KRI Dashboard & Risk Scoring (Power BI/DAX + SQL) — Personal Project**  
Defined **13 KRIs** with thresholds and weighted scoring; built Power BI dashboard (trend, drill-down, top drivers, exceptions, DQ checks) and documented scoring + refresh logic (GitHub).